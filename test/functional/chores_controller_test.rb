...
class ChoresControllerTest < ActionController::TestCase
  ...
  test "should create chore" do
    assert_difference('Chore.count') do
      post :create, chore: { ch_completed: @chore.ch_completed, ch_date: @chore.ch_date, ch_name: @chore.ch_name }
    end
  ...
  test "should update chore" do
    put :update, id: @chore, chore: { ch_completed: @chore.ch_completed, ch_date: @chore.ch_date, ch_name: @chore.ch_name }
    assert_redirected_to chore_path(assigns(:chore))
  end
